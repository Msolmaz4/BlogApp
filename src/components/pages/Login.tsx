...
const Login = () => {
  ...
  return (
    <div className="min-h-screen	 bg-slate-300 justify-center flex flex-col items-center">
      <div className="flex flex-col items-center  ">
        <label className="text-black-800 text-xl	">User</label>
        ...
        <div>
          ...
          <button
            ...
            onClick={() => navigate("/")}
            className="px-6 py-3 mr-6 text-white duration-100 bg-indigo-600 rounded-lg shadow-md focus:shadow-none ring-offset-2 ring-indigo-600 focus:ring-2 mt-6"
          >
            Home
          </button>
          <button
